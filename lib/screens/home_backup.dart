      ...
      body: CustomScrollView(
        slivers: [
          ...
          SliverAppBar(
            ...
            expandedHeight: mediaHeight * 0.35,
              ...
              children: [
                      ...
                      itemBuilder: (context, index) {
                        return CoffeeFlavorCard(
                          onTap: () {
                            ...
                            selectedCategory = coffeeFlavors[index];
                ...
                filteredItems.isEmpty
                  ...
                  child: GridView.builder(
                    ...
                    itemBuilder: (context, index) {
                      return ItemCard(
                        isFavorite: CoffeeShopItems().favoriteItems.contains(filteredItems[index]),
                        onFavoriteTap: () {
                          if (!CoffeeShopItems().favoriteItems.contains(filteredItems[index])) {
                            setState(() {
                              CoffeeShopItems().favoriteItems.add(filteredItems[index]);
                            });
                        ...
                        onButtonTap: () {
                          ShoppingCart().addItem(filteredItems[index]);
                          setState(() {
                          ...
                          Navigator.push(context, MaterialPageRoute(
                            builder: (context) {
                              return DetailitemView(
                                ...
                                isFavourite: CoffeeShopItems().favoriteItems.contains(filteredItems[index]),
                              );
                            },
                          ));
                        },
